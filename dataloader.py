...
def create_dataset(dataset_path, do_train, repeat_num=1, batch_size=32, num_parallel_workers=1):
    """
    ...
    # if device_num == 1:
    dataset = ds.ImageFolderDatasetV2(dataset_path, num_parallel_workers=num_parallel_workers, shuffle=True)
    # else:
    #     dataset = ds.ImageFolderDatasetV2(dataset_path, num_parallel_workers=num_parallel_workers, shuffle=True,
